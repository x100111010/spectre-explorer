...
function Dashboard() {
  ...
  const [address, setAddress] = useState("spectre:");
  ...
  return (
    <div className="align-spectre-top">
      <Modal show={showLoadingModal} animation={false} centered>
        <Modal.Body className="d-flex flex-row justify-content-center" style={{backgroundColor: "#0E121E"}}>
        ...
        <Container className="firstRow webpage" fluid>
          <Row>
            <Col md={12} className='d-flex flex-row justify-content-start text-light d-xs-none align-items-center'>
              <img className="big-spectre-icon" src="/k-icon-glow.png" />
            ...
            <Col xs={11}>
              <Form onSubmit={search}>
                <InputGroup className="ms-md-5 mt-5 me-5 dashboard-search-box">
                  <Form.Control className="bg-light text-dark shadow-none" name="searchInput" type="text" placeholder="Search for spectre:address or block" />
      ...
      <div className="row2">
        <Container className="secondRow webpage" fluid>
          <Row>
            ...
            <Col sm={12} md={6} xl={3}><div className="infoBox"><SpectredInfoBox /></div></Col>
