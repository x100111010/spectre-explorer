            ...
            <table style={{ fontSize: "1rem" }}>
                ...
                <tr>
                    <td className="cardBoxElement align-top">
                        Total</td>
                    <td className="">
                        <div id="coins">{numberWithCommas(circCoins)} SPR
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td className="pt-1">{(circCoins / 1161000000 * 100).toFixed(2)} %</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td className="pt-1">{halvingDate}<br /><div className="text-end w-100 pe-3 pt-1" style={{ fontSize: "small" }}>to {halvingAmount} SPR</div></td>
                </tr>
            </table>
        </div>
    </>
